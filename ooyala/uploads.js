...
exports.uploadVideoReplaceAsset = function(id, urls, buffer) {
    return this._uploadVideoAsset(
        id, urls, buffer, this.setVideoReplaceUploadStatus.bind(this)
    )
}
...
exports.processVideoWithCustomTranscoder = function(id, ppid) {
    return this
        .post({
            route: `/v2/assets/${id}/process`,
            options: {
                body: {
                    "initiation_type": "original_ingest",
...
exports.setVideoReplaceUploadStatus = function(id) {
    return this.setVideoUploadStatus(
        id, `/v2/assets/${id}/replacement/upload_status`
    )
}
